...
class Local(val contextName: String = "docker", val host: String = "localhost", val portNum: Int = 5001) : Provider {
    private val titanServerVersion = "0.8.5"
    ...
    override fun getRepositoriesApi(): RepositoriesApi {
        return this.repositoriesApi
    }

    override fun getCommitsApi(): CommitsApi {
        return this.commitsApi
    }

    override fun getVolumesApi(): VolumesApi {
        return this.volumesApi
    }

    override fun getDocker(): Docker {
        return this.docker
    }
    ...
    override fun list(context: String) {
        for (container in getContainersStatus()) {
            val out = "%-12s  %-20s  %s".format(context, container.name, container.status)
            ui?.sendMessage(out)
        }
    }
    ...
    override fun delete(repository: String, commit: String?, tags: List<String>) {
        ...
        ui?.sendMessage("No object found to delete.")
    }
