...
public class UpdateCommandStep extends liquibase.command.AbstractCommandStep {
    ...
    public void run(CommandResultsBuilder resultsBuilder) throws Exception {
        ...
        RepositoryStatus repoStatus = titan.getProvider().getRepositoriesApi().getRepositoryStatus(targetDB);
        String commit = repoStatus.getLastCommit();
        ...
        try {
            ...
            titan.getProvider().checkout(titan.getContainer(), commit, new ArrayList<>());
